        ...
        questions: [
            {
                ...
                answers: ["1219 год", "1465–1466 годы", "1511 год", "1731 год"],
                correct: 1
            },
            {
                question: "Кто считается одним из основателей Казахского ханства?",
                answers: ["Керей хан", "Абылай хан", "Касым хан", "Тауке хан"],
                correct: 0
            },
            {
                question: "Как назывался свод законов при Тауке хане?",
                answers: ["Жеты Жаргы", "Яса", "Касым ханның қасқа жолы", "Есім ханның ескі жолы"],
                correct: 0
            },
            {
            ...
            },
            {
                ...
                answers: ["Алматы", "Шымкент", "Астана", "Тараз"],
                correct: 2
            }
        ]
    },
        ...
        questions: [
            {
                ...
                answers: ["Древний Египет", "Древняя Греция", "Римская империя", "Персия"],
                correct: 0
            },
            {
                question: "Кто был верховным богом в Древней Греции?",
                answers: ["Арес", "Зевс", "Аполлон", "Посейдон"],
                correct: 1
            },
            {
                question: "Какой город считается родиной демократии?",
                answers: ["Спарта", "Рим", "Афины", "Троя"],
                correct: 2
            },
            {
                question: "Как назывался письменный материал Древнего Египта?",
                answers: ["Пергамент", "Папирус", "Бумага", "Береста"],
                correct: 1
            },
            {
                question: "Кто, согласно легенде, основал Рим?",
                answers: ["Цезарь и Август", "Ромул и Рем", "Сократ и Платон", "Филипп и Александр"],
                correct: 1
            }
        ]
    },
        ...
        questions: [
            {
                ...
                answers: ["Феодализм", "Капитализм", "Социализм", "Демократия"],
                correct: 0
            },
            {
                question: "В каком году произошло Крещение Руси?",
                answers: ["862", "988", "1066", "1215"],
                correct: 1
            },
            {
                question: "Кто завоевал Англию в 1066 году?",
                answers: ["Карл Великий", "Вильгельм Завоеватель", "Ричард Львиное Сердце", "Генрих VIII"],
                correct: 1
            },
            {
                question: "Как назывался главный город Византийской империи?",
                answers: ["Рим", "Афины", "Константинополь", "Париж"],
                correct: 2
            },
            {
                question: "Как назывались военные походы европейских христиан на Восток?",
                answers: ["Пунические войны", "Крестовые походы", "Столетняя война", "Наполеоновские войны"],
                correct: 1
            }
        ]
    },
    modern: {
        ...
        questions: [
            ...
            },
            {
                ...
                answers: ["НАТО", "ООН", "ЕС", "СНГ"],
                correct: 1
            },
            {
                question: "Как называлось противостояние СССР и США после Второй мировой войны?",
                answers: ["Холодная война", "Столетняя война", "Крымская война", "Семилетняя война"],
                correct: 0
            },
            {
...
function openRegistration() {
    const regModal = document.getElementById("registration");
...
function createProfile() {
    ...
    const profile = { name: name, class: studentClass, goal: goal };
...
function loadQuestion() {
    ...
    document.getElementById("quiz-topic").textContent = currentQuiz.name;
    document.getElementById("question-number").textContent = `Вопрос ${currentQuestion + 1} из ${currentQuiz.questions.length}`;
    document.getElementById("score").textContent = `${score} баллов`;
    ...
    question.answers.forEach(function(answer, index) {
        ...
        button.onclick = function() { chooseAnswer(index, button); };
...
function showResult() {
    ...
    if (percentage === 100) message = "🏆 Отлично! Все ответы правильные!";
    else if (percentage >= 80) message = "🎉 Очень хороший результат!";
    else if (percentage >= 60) message = "👍 Неплохой результат!";
    else message = "📚 Стоит ещё немного повторить тему.";
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (toggleBtn && chatContainer) {
        toggleBtn.addEventListener('click', () => chatContainer.classList.toggle('ai-hidden'));
    }

    if (closeBtn && chatContainer) {
        closeBtn.addEventListener('click', () => chatContainer.classList.add('ai-hidden'));
    }
